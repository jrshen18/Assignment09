...
DBiesinger, 2020-Jan-02, Modified to add Track class, added methods to CD class to handle tracks
Jeffrey Shen, 2020-Mar-20, added track class definitions and functions
...
class CD:
    ...
    def __init__(self, cd_id: int, cd_title: str, cd_artist: str) -> None:
        """Set ID, Title, Artist, Track of a new CD Object"""
        #    -- Attributes  -- #
        try:
    ...
    def cd_tracks(self, value):
        try:
            ...
            raise Exception('Tracks needs to be List!')
